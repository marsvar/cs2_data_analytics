  ...
  return (
    <div className="card-1 p-5 md:p-6">
      <div className="flex items-center justify-between gap-3 mb-4 flex-wrap">
        <div>
          <h2 className="label-sm text-accent">Upcoming Matches</h2>
      ...
      {!loadingMatches && allMatches.length > 0 && (
        <div className="space-y-4">
          <div>
            <p className="label-sm text-accent mb-2">Not played yet</p>
          ...
          <div>
            <div className="mb-2 flex items-center justify-between gap-3">
              <p className="label-sm text-success">Previous round</p>
  ...
  return (
    <main className="min-h-dvh atlas-shell">
      ...
      <section className="px-6 md:px-10 pb-16 max-w-5xl mx-auto w-full">
        <div className="card-1 p-5 md:p-6">
          <div className="mb-3">
            <h2 className="label-sm text-accent">Search for a match</h2>
